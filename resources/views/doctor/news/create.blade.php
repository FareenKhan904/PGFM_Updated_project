...
@section('title', 'Add News - Doctor Dashboard')
    ...
    <div class="col-lg-8 mx-auto">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-info text-white">
                <h4 class="mb-0"><i class="fas fa-plus me-2"></i>Add New News</h4>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('doctor.news.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="0" {{ old('type') == '0' ? 'selected' : '' }}>Classes News</option>
                            <option value="1" {{ old('type') == '1' ? 'selected' : '' }}>Reference News</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="form-text text-muted">Optional: Upload an image for this news item (max 2MB)</small>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
