...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('doctor.profile.show') }}" class="btn btn-secondary">
                ...
                <form action="{{ route('doctor.profile.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 text-center">
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            ...
                            @if($user->profile_picture)
                            <form action="{{ route('doctor.profile.removePicture') }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to remove your profile picture?');">
                                @csrf
                                @method('DELETE')
