    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0"><i class="fas fa-user-md me-2"></i>Profile Information</h4>
            </div>
            <div class="card-body">
                ...
                <div class="text-center mb-4">
                    ...
                    <h5 class="mt-3 mb-0">Dr. {{ $user->name }}</h5>
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <div class="text-center mb-3">
                    ...
                    @endif
                    <h5>Dr. {{ $user->name }}</h5>
                    <p class="text-muted mb-0">Doctor Account</p>
                </div>
                <hr>
        ...
        <div class="card border-0 shadow-sm mt-4">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('doctor.courses.index') }}" class="btn btn-outline-info">
                        <i class="fas fa-graduation-cap me-2"></i>Manage Courses
                    </a>
                    <a href="{{ route('doctor.news.index') }}" class="btn btn-outline-success">
