...
@section('title', 'Edit Course - Doctor Dashboard')
    ...
    <div class="col-lg-10 mx-auto">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4">
                <form action="{{ route('doctor.courses.update', $course) }}" method="POST" id="courseForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('subtitle') is-invalid @enderror" id="subtitle" name="subtitle" value="{{ old('subtitle', $course->subtitle) }}" placeholder="e.g., Postgraduate Qualification (Experience-Based Pathway)">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="3" maxlength="2000" oninput="updateCharCount()">{{ old('description', $course->description) }}</textarea>
                            <small class="form-text text-muted">
                                <span id="charCount">{{ strlen(old('description', $course->description ?? '')) }}</span> / 2000 characters - Brief description for course cards
                            </small>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('program_overview') is-invalid @enderror" id="program_overview" name="program_overview" rows="5">{{ old('program_overview', $course->program_overview) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('duration') is-invalid @enderror" id="duration" name="duration" value="{{ old('duration', $course->duration) }}" placeholder="e.g., 3 months, 6 weeks">
                                @error('duration')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('icon_class') is-invalid @enderror" id="icon_class" name="icon_class" value="{{ old('icon_class', $course->icon_class ?? 'fa-graduation-cap') }}" placeholder="fa-graduation-cap">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('fee') is-invalid @enderror" id="fee" name="fee" value="{{ old('fee', $course->fee) }}" placeholder="0.00" min="0">
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">PKR</span>
                                    <input type="number" step="0.01" class="form-control @error('early_bird_fee') is-invalid @enderror" id="early_bird_fee" name="early_bird_fee" value="{{ old('early_bird_fee', $course->early_bird_fee) }}" placeholder="0.00" min="0">
                                </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('awarding_body') is-invalid @enderror" id="awarding_body" name="awarding_body" value="{{ old('awarding_body', $course->awarding_body) }}" placeholder="e.g., College of Physicians and Surgeons Pakistan (CPSP)">
                            @error('awarding_body')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('goal') is-invalid @enderror" id="goal" name="goal" rows="2">{{ old('goal', $course->goal) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('qualification_purpose') is-invalid @enderror" id="qualification_purpose" name="qualification_purpose" rows="4">{{ old('qualification_purpose', $course->qualification_purpose) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('examination_components') is-invalid @enderror" id="examination_components" name="examination_components" rows="4" placeholder='Enter each component on a new line'>{{ old('examination_components', is_array($course->examination_components) ? implode("\n", $course->examination_components) : $course->examination_components) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('examination_structure') is-invalid @enderror" id="examination_structure" name="examination_structure" rows="5">{{ old('examination_structure', $course->examination_structure) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('examination_details') is-invalid @enderror" id="examination_details" name="examination_details" rows="4">{{ old('examination_details', $course->examination_details) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('eligibility_criteria') is-invalid @enderror" id="eligibility_criteria" name="eligibility_criteria" rows="5" placeholder='Enter each criterion on a new line'>{{ old('eligibility_criteria', is_array($course->eligibility_criteria) ? implode("\n", $course->eligibility_criteria) : $course->eligibility_criteria) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('eligibility_attempts') is-invalid @enderror" id="eligibility_attempts" name="eligibility_attempts" rows="3">{{ old('eligibility_attempts', $course->eligibility_attempts) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('mandatory_workshops') is-invalid @enderror" id="mandatory_workshops" name="mandatory_workshops" rows="4" placeholder='Enter each workshop on a new line'>{{ old('mandatory_workshops', is_array($course->mandatory_workshops) ? implode("\n", $course->mandatory_workshops) : $course->mandatory_workshops) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('course_modules') is-invalid @enderror" id="course_modules" name="course_modules" rows="5" placeholder='Enter each module on a new line'>{{ old('course_modules', is_array($course->course_modules) ? implode("\n", $course->course_modules) : $course->course_modules) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('skills_assessed') is-invalid @enderror" id="skills_assessed" name="skills_assessed" rows="5" placeholder='Enter each skill on a new line'>{{ old('skills_assessed', is_array($course->skills_assessed) ? implode("\n", $course->skills_assessed) : $course->skills_assessed) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('whats_included') is-invalid @enderror" id="whats_included" name="whats_included" rows="5" placeholder='Enter each item on a new line'>{{ old('whats_included', is_array($course->whats_included) ? implode("\n", $course->whats_included) : $course->whats_included) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>Note:</strong> All optional fields will only be displayed on the public page if they are filled.
                        </div>
                    </div>
